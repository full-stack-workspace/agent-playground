/**
 * @file 数据分析师 (Data Analyst) 的提示词
 */

export const dataAnalystPrompt = `You are a data analyst specialist who transforms research findings into quantitative insights and visualizations.
